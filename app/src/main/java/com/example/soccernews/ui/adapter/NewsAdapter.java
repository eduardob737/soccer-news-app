...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public NewsAdapter(List<News> news, FavoriteListener favoriteListener, NewsViewModel.State state) {
        this.news = news;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        switch (state) {
            case ERROR:
            case DOING:
                holder.binding.skeletonLayout.showSkeleton();
                break;
            default:
                holder.binding.skeletonLayout.showOriginal();
